...
import com.byb.gambler.views.MoreView;
...
public class MoreActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		moreContext = this;
		animLeftIn = AnimationUtils.loadAnimation(moreContext, R.anim.slide_in_left);
		animLeftIn.setDuration(500);
		animRightOut = AnimationUtils.loadAnimation(moreContext, R.anim.slide_out_right);
		animRightOut.setDuration(500);
		animRightIn = AnimationUtils.loadAnimation(moreContext, R.anim.slide_in_right);
		animRightIn.setDuration(500);
		animLeftOut = AnimationUtils.loadAnimation(moreContext, R.anim.slide_out_left);
		animLeftOut.setDuration(500);
		moreActivity = this;
		
		if(savedInstanceState==null)
		setView(MoreView.getView(getApplicationContext()));
	}
...
//		setView(newView, false);
		moreActivity.setContentView(newView);
	}
	public static void setView(View newView,boolean isBack){
		...
		currentView = newView;
		moreActivity.setContentView(currentView);
		if(isBack)
